...
const Digital_strategy = () => {
  ...
  return (
    ...
    <Herosection data={"DIGITAL STRAGTEGY PLANNING"}/>

<div className='w-[70%] xl:w-10/12 flex justify-center  flex-col gap-5 pt-24 pb-14 leading-10'>
<p className='text-4xl font-bold'>Soar Above the Competition with No Gravity Media's Digital Strategy Planning


</p>
<p className='font-light min-xl:text-2xl min-xl:leading-9  '>Welcome to No Gravity Media, where we specialize in crafting bespoke digital strategy plans tailored to propel businesses to new heights in the dynamic online landscape. With the digital realm evolving at a rapid pace, it's crucial for businesses to have a well-defined roadmap that aligns with their goals and resonates with their target audience. That's where our expertise comes into play.
</p>
</div>
...
export default Digital_strategy